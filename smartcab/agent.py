...
class LearningAgent(Agent):
    """ An agent that learns to drive in the Smartcab world.
        This is the object we will be modifying. """
    ...
    def build_state(self):
        ...
        # NOTE : we are not allowed to engineer eatures outside of the inputs available.
        # Because the aim of this project is to teach Reinforcement Learning, we have placed
        # constraints in order for you to learn how to adjust epsilon and alpha, and thus learn about the balance between exploration and exploitation.
        # With the hand-engineered features, this learning process gets entirely negated.

        # Set 'state' as a tuple of relevant data for the agent
        # Dirty solution convert dict to tuples:
        state = (inputs.items()[0],inputs.items()[1],inputs.items()[2],inputs.items()[3],waypoint)
        # return (('light', 'red'), ('oncoming', None), ('right', None), ('left', None), 'left')
    ...
    def get_maxQ(self, state):
        ...
        # maxQ = sorted(state_dict.keys(), key=state_dict.get, reverse=True)[0]
        # print self.Q[state])
